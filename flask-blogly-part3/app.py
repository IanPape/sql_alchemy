...
def users_show(user_id):
    ...
    for post in user.posts:
        post.tags = Tag.query.join(PostTag).filter(PostTag.post_id == post.id).all()
...
def posts_show(post_id):
    ...
    tags = post.tags  # Assuming post.tags is correctly set up
    print(tags)  # Debug statement to print tags
